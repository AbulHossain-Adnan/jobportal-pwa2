        ...
        <div class="col-12">
            <div class="card">
                <div class="row card-header bg-transparent border-bottom">
                    <div class="col-md-8">
                        <h4 class="card-title">List Of Workshops</h4>
                        <span>
                            This is an Workshop related information about Alumni and Student
                        </span>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered dt-responsive  nowrap w-100">
                        ...
                        <tbody>
                        <tr v-for="(workshop, index) of workshops">
                            <td>{{ workshop.id }}</td>
                            <td>{{ workshop.title }}</td>
                            <td>{{ workshop.description }}</td>
                            <td>{{ workshop.duration_in_days }}</td>
