      ...
      <div class="d-flex">
        ...
        <div class="dropdown d-inline-block">
          ...
          <div class="dropdown-menu dropdown-menu-end">
            ...
            <router-link :to="{ name: 'dashboard_profile' }" key="t-light-sidebar" class="dropdown-item"><i class="bx bx-user font-size-16 align-middle me-1"></i>   <span key="t-profile">Profile</span> </router-link>
...
export default {
  ...
  methods:{
    logout() {
      if (Cookies.get('jobUserLoggedInToken') && Cookies.get('authIdCookie')){
