        ...
        <div class="padding-right">
          <div class="listings-container">
            ...
            <router-link
              ...
              v-for="(item, index) in searchjobs"
          ...
          <div v-if="searchjobs.length" class="d-flex">
            <div
              class="col-md-4 pl-0"
              style="margin: auto"
              v-if="searchjobs.length"
            >
...
export default {
  ...
  methods: {
    getData(url) {
      ...
      // console.log(this.selected.prices.length ==0);

      let linkUrl = url ? url :  `${this.backendUrl}jobpostsearch/` + this.$route.query.search ;
                axios.get(linkUrl, {
                    params: {
                  ...
                  .then((response) => {
                    ...
                    console.log('response a ayse')

                        this.searchjobs = response.data.data;
