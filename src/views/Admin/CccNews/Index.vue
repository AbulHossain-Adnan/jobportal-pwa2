            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered dt-responsive  nowrap w-100">
                        ...
                        <tbody>
                                <tr v-for="(cccnew, index) of cccnews">
                                    <td>
                                        {{ cccnew.id }}
                                    </td>

                                    <td class="text-center">
                                        <img width="80" :src="cccnew.image" :alt="cccnew.id">
                                    </td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button type="button" @click="destroy(cccnew)" class="btn btn-danger btn-sm">
...
export default {
    ...
    methods: {
      getData(url) {
        ...
        //     this.$Progress.start()
        //     this.form.busy = true
        //     this.form.post(`${this.backendUrl}career-counselling`)
        //     .then(response => {
        //         this.getData()
